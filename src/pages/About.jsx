...
export default function About() {
  return (
    ...
    >
      <section>
        <h1 className="text-3xl font-semibold mb-4 text-blue-900">About Us</h1>
      </section>

      <section>
        <h2 className="text-2xl font-bold text-blue-900 mb-4">Our Legacy</h2>
      ...
      <section>
        <h2 className="text-2xl font-bold text-blue-900 mb-4">Founder's Message</h2>
        <blockquote className="italic text-gray-700">
          ...
          <br /><br />
          <span className="block text-right font-semibold mt-2">- Mr. J. Roy<br />Managing Partner</span>
        </blockquote>
      </section>
    </motion.div>
  );
